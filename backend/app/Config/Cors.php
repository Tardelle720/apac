...
class Cors extends BaseConfig
{
    ...
    public array $default = [
         ...
         */
        // Allow the frontend origin(s). Using port 80 the origin is 'http://localhost'.
        // Add 'http://127.0.0.1' if you access the frontend via loopback IP.
         ...
         */
        // Common headers used by clients
